...
// Meshtastic HardwareModel enum names — full table mirroring upstream
// meshtastic/protobufs `meshtastic/mesh.proto` HardwareModel enum. Refresh
// when new boards appear upstream (curl the proto, regenerate by hand).
